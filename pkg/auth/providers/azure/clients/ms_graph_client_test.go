...
func newTestSecretsClient(ctrl *gomock.Controller) wcorev1.SecretController {
	return newTestSecretsClientWithMap(ctrl, map[types.NamespacedName]*corev1.Secret{})
}

func newTestSecretsClientWithMap(ctrl *gomock.Controller, secrets map[types.NamespacedName]*corev1.Secret) wcorev1.SecretController {
